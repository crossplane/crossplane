...
type MockClient struct {
	...
	MockCreateInstance func(name, password string, spec *v1alpha1.RDSInstanceConfiguration) (*Instance, error)
...
func (m *MockClient) CreateInstance(name, password string, spec *v1alpha1.RDSInstanceConfiguration) (*Instance, error) {
