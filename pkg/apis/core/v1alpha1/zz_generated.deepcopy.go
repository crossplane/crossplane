...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PublishConnectionTo) DeepCopyInto(out *PublishConnectionTo) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PublishConnectionTo.
func (in *PublishConnectionTo) DeepCopy() *PublishConnectionTo {
	if in == nil {
		return nil
	}
	out := new(PublishConnectionTo)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ResourceClaimSpec) DeepCopyInto(out *ResourceClaimSpec) {
	*out = *in
	in.PublishConnectionTo.DeepCopyInto(&out.PublishConnectionTo)
...
func (in *SecretTransform) DeepCopyInto(out *SecretTransform) {
	*out = *in
	...
	out.DestinationReference = in.DestinationReference
