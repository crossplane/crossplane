...
func (in *AbstractResourceStatus) DeepCopyInto(out *AbstractResourceStatus) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AbstractResourceStatus.
func (in *AbstractResourceStatus) DeepCopy() *AbstractResourceStatus {
	if in == nil {
		return nil
	}
	out := new(AbstractResourceStatus)
	in.DeepCopyInto(out)
	return out
}
