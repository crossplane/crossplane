...
func (i *CloudsqlInstance) DeepCopyInto(out *CloudsqlInstance) {
	*out = *i
	out.TypeMeta = i.TypeMeta
	i.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	i.Spec.DeepCopyInto(&out.Spec)
	i.Status.DeepCopyInto(&out.Status)
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CloudsqlInstance.
func (i *CloudsqlInstance) DeepCopy() *CloudsqlInstance {
	if i == nil {
		return nil
	}
...
func (i *CloudsqlInstance) DeepCopyObject() runtime.Object {
	if c := i.DeepCopy(); c != nil {
		return c
	}
	return nil
}
