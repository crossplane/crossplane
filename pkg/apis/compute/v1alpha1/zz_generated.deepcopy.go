...
func (in *WorkloadSpec) DeepCopyInto(out *WorkloadSpec) {
	*out = *in
	...
	in.Selector.DeepCopyInto(&out.Selector)
	if in.MySQLResourceReferences != nil {
		in, out := &in.MySQLResourceReferences, &out.MySQLResourceReferences
		*out = make([]ResourceReference, len(*in))
		copy(*out, *in)
	}
	if in.BucketResourceReferences != nil {
		in, out := &in.BucketResourceReferences, &out.BucketResourceReferences
		*out = make([]ResourceReference, len(*in))
		copy(*out, *in)
	}
	return
