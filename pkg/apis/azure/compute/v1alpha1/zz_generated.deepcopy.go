...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AKSClusterFuture.
func (in *AKSClusterFuture) DeepCopy() *AKSClusterFuture {
	if in == nil {
		return nil
	}
	out := new(AKSClusterFuture)
	in.DeepCopyInto(out)
	return out
}
...
func (in *AKSClusterStatus) DeepCopyInto(out *AKSClusterStatus) {
	*out = *in
	...
	if in.RunningOperation != nil {
		in, out := &in.RunningOperation, &out.RunningOperation
		*out = (*in).DeepCopy()
	}
	return
}
