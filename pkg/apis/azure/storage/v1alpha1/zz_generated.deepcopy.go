...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TestAccount) DeepCopyInto(out *TestAccount) {
	*out = *in
	if in.Account != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TestAccount.
func (in *TestAccount) DeepCopy() *TestAccount {
	if in == nil {
		return nil
	}
	out := new(TestAccount)
