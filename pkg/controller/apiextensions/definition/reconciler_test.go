					...
					WithClientApplicator(resource.ClientApplicator{
						Client: &test.MockClient{
							...
							MockStatusUpdate: test.NewMockStatusUpdateFn(nil, func(got runtime.Object) error {
								...
								want.Status.SetConditions(v1alpha1.TerminatingComposite())
					...
					WithClientApplicator(resource.ClientApplicator{
						Client: &test.MockClient{
							MockGet: test.NewMockGetFn(nil, func(obj runtime.Object) error {
								d := obj.(*v1alpha1.CompositeResourceDefinition)
								d.Spec.Versions = []v1alpha1.CompositeResourceDefinitionVersion{
									{Name: "old", Referenceable: false},
									{Name: "new", Referenceable: true},
								}
								d.Status.Controllers.CompositeResourceTypeRef = v1alpha1.TypeReference{APIVersion: "old"}
								return nil
							}),
							MockStatusUpdate: test.NewMockStatusUpdateFn(nil, func(o runtime.Object) error {
								want := &v1alpha1.CompositeResourceDefinition{}
								want.Spec.Versions = []v1alpha1.CompositeResourceDefinitionVersion{
									{Name: "old", Referenceable: false},
									{Name: "new", Referenceable: true},
								}
								want.Status.Controllers.CompositeResourceTypeRef = v1alpha1.TypeReference{APIVersion: "new"}
								want.Status.SetConditions(v1alpha1.WatchingComposite())
