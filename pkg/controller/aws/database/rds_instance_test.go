...
func TestReconcile(t *testing.T) {
	...
	instance := &databasev1alpha1.RDSInstance{ObjectMeta: metav1.ObjectMeta{Name: "foo", Namespace: "default"}}
	...
	recFn, requests := SetupTestReconcile(newRDSInstanceReconciler(mgr))
