...
func AddClaim(mgr manager.Manager) error {
	...
	if err := c.Watch(
		&source.Kind{Type: &v1alpha1.EKSCluster{}},
...
func ConfigureEKSCluster(ctx context.Context, cm resource.Claim, cs *corev1alpha1.ResourceClass, mg resource.Managed) error {
