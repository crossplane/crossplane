...
type ControllerConfigInterface interface {
	Create(ctx context.Context, controllerConfig *v1beta1.ControllerConfig, opts v1.CreateOptions) (*v1beta1.ControllerConfig, error)
	Update(ctx context.Context, controllerConfig *v1beta1.ControllerConfig, opts v1.UpdateOptions) (*v1beta1.ControllerConfig, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1beta1.ControllerConfig, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1beta1.ControllerConfigList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.ControllerConfig, err error)
...
func newControllerConfigs(c *PkgV1beta1Client) *controllerConfigs {
...
func (c *controllerConfigs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.ControllerConfig, err error) {
	result = &v1beta1.ControllerConfig{}
	err = c.client.Get().
...
func (c *controllerConfigs) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.ControllerConfigList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.ControllerConfigList{}
	err = c.client.Get().
		Resource("controllerconfigs").
...
func (c *controllerConfigs) Create(ctx context.Context, controllerConfig *v1beta1.ControllerConfig, opts v1.CreateOptions) (result *v1beta1.ControllerConfig, err error) {
	result = &v1beta1.ControllerConfig{}
	err = c.client.Post().
		Resource("controllerconfigs").
		VersionedParams(&opts, scheme.ParameterCodec).
...
func (c *controllerConfigs) Update(ctx context.Context, controllerConfig *v1beta1.ControllerConfig, opts v1.UpdateOptions) (result *v1beta1.ControllerConfig, err error) {
	result = &v1beta1.ControllerConfig{}
	err = c.client.Put().
		Resource("controllerconfigs").
...
func (c *controllerConfigs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.ControllerConfig, err error) {
	result = &v1beta1.ControllerConfig{}
