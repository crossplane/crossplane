...
// ApiextensionsV1alpha1Client is used to interact with features provided by the apiextensions.crossplane.io group.
type ApiextensionsV1alpha1Client struct {
	restClient rest.Interface
}

func (c *ApiextensionsV1alpha1Client) CompositeResourceDefinitions() CompositeResourceDefinitionInterface {
	return newCompositeResourceDefinitions(c)
}

func (c *ApiextensionsV1alpha1Client) Compositions() CompositionInterface {
