...
// ApiextensionsV1beta1Client is used to interact with features provided by the apiextensions.crossplane.io group.
type ApiextensionsV1beta1Client struct {
	restClient rest.Interface
}

func (c *ApiextensionsV1beta1Client) CompositeResourceDefinitions() CompositeResourceDefinitionInterface {
	return newCompositeResourceDefinitions(c)
}

func (c *ApiextensionsV1beta1Client) Compositions() CompositionInterface {
