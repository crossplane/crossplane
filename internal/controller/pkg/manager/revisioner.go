...
type Revisioner interface {
	Revision(ctx context.Context, p v1.Package, pullSecretFromConfig string) (string, error)
}
...
func (r *PackageRevisioner) Revision(ctx context.Context, p v1.Package, pullSecretFromConfig string) (string, error) {
	...
	if pullSecretFromConfig != "" {
		ps = append(ps, pullSecretFromConfig)
	}
