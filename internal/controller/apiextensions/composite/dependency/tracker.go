...
// InMemoryTracker is an in-memory Tracker.
...
// recorded for it.
func (t *InMemoryTracker) Track(xr client.ObjectKey, composed []Reference, required []Requirement) {
...
// Forget drops all references recorded for an XR.
func (t *InMemoryTracker) Forget(xr client.ObjectKey) {
	t.mu.Lock()
	defer t.mu.Unlock()
...
func (t *InMemoryTracker) Requirements(xr client.ObjectKey, step string) []Requirement {
	t.mu.RLock()
	defer t.mu.RUnlock()
...
func (t *InMemoryTracker) Dependants(obj client.Object) []client.ObjectKey {
...
func (t *InMemoryTracker) GVKs() []schema.GroupVersionKind {
	t.mu.RLock()
	defer t.mu.RUnlock()
...
// write lock.
func (t *InMemoryTracker) add(xr client.ObjectKey, r Reference, sel labels.Selector) {
	t.gvks[r.GVK]++
...
// lock.
func (t *InMemoryTracker) remove(xr client.ObjectKey, r Reference) {
