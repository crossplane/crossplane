				...
				mgr: &fake.Manager{
					Client: &test.MockClient{
						...
						MockCreate: test.NewMockCreateFn(nil, func(got client.Object) error {
							want, _ := NewCompositionRevision(compDev, rev2.Spec.Revision+1, compDev.Hash())
			...
			args: args{
				mgr: &fake.Manager{
					Client: &test.MockClient{
						...
						MockCreate: test.NewMockCreateFn(nil, func(got client.Object) error {
							want, _ := NewCompositionRevision(compStaging, rev3.Spec.Revision+1, compStaging.Hash())
			...
			args: args{
				mgr: &fake.Manager{
					Client: &test.MockClient{
						...
						MockCreate: test.NewMockCreateFn(nil, func(got client.Object) error {
							want, _ := NewCompositionRevision(compDevWithAnn, rev3.Spec.Revision+1, compDevWithAnn.Hash())
