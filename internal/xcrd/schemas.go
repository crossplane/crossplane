...
func CompositeResourceSpecProps(s v2.CompositeResourceScope, defaultPol *xpv1.UpdatePolicy) map[string]extv1.JSONSchemaProps {
	...
	// namespaces.
	if s == v2.CompositeResourceScopeNamespaced {
	...
	if s == v2.CompositeResourceScopeLegacyCluster { //nolint:staticcheck // we are still supporting v1 XRD
...
func CompositeResourceStatusProps(s v2.CompositeResourceScope) map[string]extv1.JSONSchemaProps {
	props := map[string]extv1.JSONSchemaProps{
		"conditions": {
	...
	switch s {
	case v2.CompositeResourceScopeNamespaced, v2.CompositeResourceScopeCluster:
	...
	case v2.CompositeResourceScopeLegacyCluster: //nolint:staticcheck // we are still supporting v1 XRD
...
func CompositeResourcePrinterColumns(s v2.CompositeResourceScope) []extv1.CustomResourceColumnDefinition {
