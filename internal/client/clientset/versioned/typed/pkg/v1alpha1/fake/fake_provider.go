...
var providersResource = schema.GroupVersionResource{Group: "pkg.crossplane.io", Version: "v1alpha1", Resource: "providers"}

var providersKind = schema.GroupVersionKind{Group: "pkg.crossplane.io", Version: "v1alpha1", Kind: "Provider"}
...
func (c *FakeProviders) UpdateStatus(ctx context.Context, provider *v1alpha1.Provider, opts v1.UpdateOptions) (*v1alpha1.Provider, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(providersResource, "status", provider), &v1alpha1.Provider{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.Provider), err
...
func (c *FakeProviders) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteActionWithOptions(providersResource, name, opts), &v1alpha1.Provider{})
	return err
}
...
func (c *FakeProviders) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Provider, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(providersResource, name, pt, data, subresources...), &v1alpha1.Provider{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.Provider), err
