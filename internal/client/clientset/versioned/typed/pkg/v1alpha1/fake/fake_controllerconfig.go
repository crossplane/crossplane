...
var controllerconfigsResource = v1alpha1.SchemeGroupVersion.WithResource("controllerconfigs")

var controllerconfigsKind = v1alpha1.SchemeGroupVersion.WithKind("ControllerConfig")
