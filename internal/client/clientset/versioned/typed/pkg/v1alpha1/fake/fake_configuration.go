...
var configurationsResource = schema.GroupVersionResource{Group: "pkg.crossplane.io", Version: "v1alpha1", Resource: "configurations"}

var configurationsKind = schema.GroupVersionKind{Group: "pkg.crossplane.io", Version: "v1alpha1", Kind: "Configuration"}
...
func (c *FakeConfigurations) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Configuration, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(configurationsResource, name), &v1alpha1.Configuration{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeConfigurations) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ConfigurationList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(configurationsResource, configurationsKind, opts), &v1alpha1.ConfigurationList{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeConfigurations) Create(ctx context.Context, configuration *v1alpha1.Configuration, opts v1.CreateOptions) (result *v1alpha1.Configuration, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(configurationsResource, configuration), &v1alpha1.Configuration{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.Configuration), err
...
func (c *FakeConfigurations) Update(ctx context.Context, configuration *v1alpha1.Configuration, opts v1.UpdateOptions) (result *v1alpha1.Configuration, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(configurationsResource, configuration), &v1alpha1.Configuration{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.Configuration), err
...
func (c *FakeConfigurations) UpdateStatus(ctx context.Context, configuration *v1alpha1.Configuration, opts v1.UpdateOptions) (*v1alpha1.Configuration, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(configurationsResource, "status", configuration), &v1alpha1.Configuration{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.Configuration), err
...
func (c *FakeConfigurations) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteActionWithOptions(configurationsResource, name, opts), &v1alpha1.Configuration{})
	return err
}
...
func (c *FakeConfigurations) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Configuration, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(configurationsResource, name, pt, data, subresources...), &v1alpha1.Configuration{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.Configuration), err
