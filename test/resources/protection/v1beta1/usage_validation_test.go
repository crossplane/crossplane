...
func TestUsageValidation(t *testing.T) {
	cases := map[string]struct {
		reason       string
		current, old *v1beta1.Usage
		validatorFn  func(obj, old *v1beta1.Usage) field.ErrorList
		wantErrs     []string
	}{
		"CreateEmpty": {
...
func TestClusterUsageValidation(t *testing.T) {
	cases := map[string]struct {
		reason       string
		current, old *v1beta1.ClusterUsage
		validatorFn  func(obj, old *v1beta1.ClusterUsage) field.ErrorList
		wantErrs     []string
	}{
		"CreateEmpty": {
