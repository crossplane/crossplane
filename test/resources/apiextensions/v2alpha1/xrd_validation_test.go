...
func TestCompositeResourceDefinitionValidation(t *testing.T) {
	cases := map[string]struct {
		reason       string
		current, old *v2alpha1.CompositeResourceDefinition
		validatorFn  func(obj, old *v2alpha1.CompositeResourceDefinition) field.ErrorList
		wantErrs     []string
	}{
		"CreateEmpty": {
			reason:      "Attempted to create an empty CompositeResourceDefinition.",
			current:     resources.New[v2alpha1.CompositeResourceDefinition](t),
			validatorFn: resources.ValidatorFor[v2alpha1.CompositeResourceDefinition](t),
			wantErrs:    []string{},
		},
	}
