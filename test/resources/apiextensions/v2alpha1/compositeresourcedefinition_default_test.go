...
func TestCompositeResourceDefinitionDefaults(t *testing.T) {
	cases := map[string]struct {
		...
		"FromEmpty": {
			...
			defaultFn: resources.DefaultFor[v2alpha1.CompositeResourceDefinition](t),
			obj:       resources.New[v2alpha1.CompositeResourceDefinition](t),
			want:      apitest.MustLoadManifest[v2alpha1.CompositeResourceDefinition](t, "compositeresourcedefinition.yaml"),
		},
	}
