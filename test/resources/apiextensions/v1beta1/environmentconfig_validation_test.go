...
func TestEnvironmentConfigValidation(t *testing.T) {
	cases := map[string]struct {
		reason       string
		current, old *v1beta1.EnvironmentConfig
		validatorFn  func(obj, old *v1beta1.EnvironmentConfig) field.ErrorList
		wantErrs     []string
	}{
		"CreateEmpty": {
			reason:      "Attempted to create an empty EnvironmentConfig.",
			current:     resources.New[v1beta1.EnvironmentConfig](t),
			validatorFn: resources.ValidatorFor[v1beta1.EnvironmentConfig](t),
			wantErrs:    []string{},
		},
	}
