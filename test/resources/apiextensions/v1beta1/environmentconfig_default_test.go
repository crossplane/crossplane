...
func TestEnvironmentConfigDefaults(t *testing.T) {
	cases := map[string]struct {
		...
		"FromEmpty": {
			...
			defaultFn: resources.DefaultFor[v1beta1.EnvironmentConfig](t),
			obj:       resources.New[v1beta1.EnvironmentConfig](t),
			want:      apitest.MustLoadManifest[v1beta1.EnvironmentConfig](t, "environmentconfig.yaml"),
		},
	}
