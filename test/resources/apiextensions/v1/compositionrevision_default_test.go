...
func TestCompositionRevisionDefaults(t *testing.T) {
	cases := map[string]struct {
		...
		"FromEmpty": {
			...
			defaultFn: resources.DefaultFor[v1.CompositionRevision](t),
			obj:       resources.New[v1.CompositionRevision](t),
			want:      apitest.MustLoadManifest[v1.CompositionRevision](t, "compositionrevision.yaml"),
		},
	}
