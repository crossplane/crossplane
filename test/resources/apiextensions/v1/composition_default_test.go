...
func TestCompositionDefaults(t *testing.T) {
	cases := map[string]struct {
		...
		"FromEmpty": {
			...
			defaultFn: resources.DefaultFor[v1.Composition](t),
			obj:       resources.New[v1.Composition](t),
			want:      apitest.MustLoadManifest[v1.Composition](t, "composition.yaml"),
		},
	}
