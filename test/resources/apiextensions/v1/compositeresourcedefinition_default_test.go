...
func TestCompositeResourceDefinitionDefaults(t *testing.T) {
	cases := map[string]struct {
		...
		"FromEmpty": {
			...
			defaultFn: resources.DefaultFor[v1.CompositeResourceDefinition](t),
			obj:       resources.New[v1.CompositeResourceDefinition](t),
			want:      apitest.MustLoadManifest[v1.CompositeResourceDefinition](t, "compositeresourcedefinition.yaml"),
		},
	}
