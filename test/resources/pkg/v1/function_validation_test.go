...
func TestFunctionValidation(t *testing.T) {
	cases := map[string]struct {
		reason       string
		current, old *v1.Function
		validatorFn  func(obj, old *v1.Function) field.ErrorList
		wantErrs     []string
	}{
		"CreateEmpty": {
			reason:      "Attempted to create an empty Function.",
			current:     resources.New[v1.Function](t),
			validatorFn: resources.ValidatorFor[v1.Function](t),
			wantErrs:    []string{},
		},
	}
...
func TestFunctionRevisionValidation(t *testing.T) {
	cases := map[string]struct {
		reason       string
		current, old *v1.FunctionRevision
		validatorFn  func(obj, old *v1.FunctionRevision) field.ErrorList
		wantErrs     []string
	}{
		"CreateEmpty": {
			reason:      "Attempted to create an empty FunctionRevision.",
			current:     resources.New[v1.FunctionRevision](t),
			validatorFn: resources.ValidatorFor[v1.FunctionRevision](t),
			wantErrs:    []string{},
		},
	}
