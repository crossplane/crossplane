...
func TestFunctionRevisionDefaults(t *testing.T) {
	cases := map[string]struct {
		...
		"FromEmpty": {
			...
			defaultFn: resources.DefaultFor[v1.FunctionRevision](t),
			obj:       resources.New[v1.FunctionRevision](t),
			want:      apitest.MustLoadManifest[v1.FunctionRevision](t, "functionrevision.yaml"),
		},
	}
