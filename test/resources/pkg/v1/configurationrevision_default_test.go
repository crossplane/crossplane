...
func TestConfigurationRevisionDefaults(t *testing.T) {
	cases := map[string]struct {
		...
		"FromEmpty": {
			...
			defaultFn: resources.DefaultFor[v1.ConfigurationRevision](t),
			obj:       resources.New[v1.ConfigurationRevision](t),
			want:      apitest.MustLoadManifest[v1.ConfigurationRevision](t, "configurationrevision.yaml"),
		},
	}
