...
func TestConfigurationDefaults(t *testing.T) {
	cases := map[string]struct {
		...
		"FromEmpty": {
			...
			defaultFn: resources.DefaultFor[v1.Configuration](t),
			obj:       resources.New[v1.Configuration](t),
			want:      apitest.MustLoadManifest[v1.Configuration](t, "configuration.yaml"),
		},
	}
