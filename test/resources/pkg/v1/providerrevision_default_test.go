...
func TestProviderRevisionDefaults(t *testing.T) {
	cases := map[string]struct {
		...
		"FromEmpty": {
			...
			defaultFn: resources.DefaultFor[v1.ProviderRevision](t),
			obj:       resources.New[v1.ProviderRevision](t),
			want:      apitest.MustLoadManifest[v1.ProviderRevision](t, "providerrevision.yaml"),
		},
	}
