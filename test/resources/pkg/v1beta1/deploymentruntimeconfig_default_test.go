...
func TestDeploymentRuntimeConfigDefaults(t *testing.T) {
	cases := map[string]struct {
		...
		"FromEmpty": {
			...
			defaultFn: resources.DefaultFor[v1beta1.DeploymentRuntimeConfig](t),
			obj:       resources.New[v1beta1.DeploymentRuntimeConfig](t),
			want:      apitest.MustLoadManifest[v1beta1.DeploymentRuntimeConfig](t, "deploymentruntimeconfig.yaml"),
		},
	}
