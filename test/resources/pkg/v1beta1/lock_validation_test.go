...
func TestLockValidation(t *testing.T) {
	cases := map[string]struct {
		reason       string
		current, old *v1beta1.Lock
		validatorFn  func(obj, old *v1beta1.Lock) field.ErrorList
		wantErrs     []string
	}{
		"CreateEmpty": {
			reason:      "Attempted to create an empty Lock.",
			current:     resources.New[v1beta1.Lock](t),
			validatorFn: resources.ValidatorFor[v1beta1.Lock](t),
			wantErrs:    []string{},
		},
	}
