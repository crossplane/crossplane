...
- It takes the discovery client no more than 10s to discover all available GVs. This would cover both the initial discovery needed by the controllers and periodic discoveries triggered by other clients such as `kubectl`.
