...
When the configuration is enabled, the package manager will automatically downgrade the dependencies to the maximum valid 
version to prevent possible issues as much as possible.
