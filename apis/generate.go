...
//go:generate go run -tags generate sigs.k8s.io/controller-tools/cmd/controller-gen object:headerFile=../hack/boilerplate.go.txt paths=./daytwo/... crd:crdVersions=v1 output:artifacts:config=../cluster/crds
