...
func (in *ApplicationConfigurationStatus) DeepCopyInto(out *ApplicationConfigurationStatus) {
	*out = *in
	...
	if in.Workloads != nil {
		...
		*out = make([]ApplicationConfigurationWorkload, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ApplicationConfigurationWorkload) DeepCopyInto(out *ApplicationConfigurationWorkload) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ApplicationConfigurationWorkload.
func (in *ApplicationConfigurationWorkload) DeepCopy() *ApplicationConfigurationWorkload {
	if in == nil {
		return nil
	}
	out := new(ApplicationConfigurationWorkload)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ComponentScope) DeepCopyInto(out *ComponentScope) {
	*out = *in
	in.ScopeReference.DeepCopyInto(&out.ScopeReference)
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TraitReference) DeepCopyInto(out *TraitReference) {
	*out = *in
	if in.UID != nil {
		in, out := &in.UID, &out.UID
		*out = new(types.UID)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TraitReference.
func (in *TraitReference) DeepCopy() *TraitReference {
	if in == nil {
		return nil
	}
	out := new(TraitReference)
	in.DeepCopyInto(out)
	return out
}
