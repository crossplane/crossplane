...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GenericObjecReference) DeepCopyInto(out *GenericObjecReference) {
	*out = *in
	if in.Name != nil {
		in, out := &in.Name, &out.Name
		*out = new(string)
	...
	if in.NameFromFieldPath != nil {
		in, out := &in.NameFromFieldPath, &out.NameFromFieldPath
		*out = new(string)
		**out = **in
	}
	if in.Namespace != nil {
	...
	if in.NamespaceFromFieldPath != nil {
		in, out := &in.NamespaceFromFieldPath, &out.NamespaceFromFieldPath
		*out = new(string)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GenericObjecReference.
func (in *GenericObjecReference) DeepCopy() *GenericObjecReference {
	if in == nil {
		return nil
	}
	out := new(GenericObjecReference)
	in.DeepCopyInto(out)
	return out
}
...
func (in *Patch) DeepCopyInto(out *Patch) {
	*out = *in
	...
	if in.FromObjectRef != nil {
		in, out := &in.FromObjectRef, &out.FromObjectRef
		*out = new(GenericObjecReference)
		(*in).DeepCopyInto(*out)
	}
	if in.Combine != nil {
