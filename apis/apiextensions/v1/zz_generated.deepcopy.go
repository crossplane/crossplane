...
func (in *PipelineStep) DeepCopyInto(out *PipelineStep) {
	*out = *in
	...
	if in.Credentials != nil {
		...
		*out = new(PipelineStepCredentials)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PipelineStepCredentials) DeepCopyInto(out *PipelineStepCredentials) {
	*out = *in
	if in.SecretRef != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PipelineStepCredentials.
func (in *PipelineStepCredentials) DeepCopy() *PipelineStepCredentials {
	if in == nil {
		return nil
	}
	out := new(PipelineStepCredentials)
