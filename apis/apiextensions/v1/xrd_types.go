...
type CompositeResourceDefinitionSpec struct {
	...
	// Composite contains settings related to composite generation.
	Composite *CompositeResourceDefinitionCompositeConfig `json:"composite,omitempty"`
...
// CompositeResourceDefinitionCompositeConfig contains settings related to
// composite generation.
type CompositeResourceDefinitionCompositeConfig struct {
	// Name defines rules for composite name generation.
	// +optional
	Name *CompositeResourceDefinitionCompositeNameConfig `json:"name,omitempty"`
}

// CompositeResourceDefinitionCompositeNameConfig defines rules for composite
// name generation.
type CompositeResourceDefinitionCompositeNameConfig struct {
	// Template is the raw helm template used to generate the composite name.
	//
	// The template will be executed for each new composite resource with data
	// from the claim:
	// * .Claim.Name
	// * .Claim.Namespace
	// * .Claim.Group
	// * .Claim.Kind
	// * .Claim.Version
	// * .Claim.GVK (string formatted GroupVersionKind)
	//
	// If template is not set, the name will be generated by the kube API server
	// by setting metadata.generateName.
	// +optional
