...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FunctionRevisionReference) DeepCopyInto(out *FunctionRevisionReference) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FunctionRevisionReference.
func (in *FunctionRevisionReference) DeepCopy() *FunctionRevisionReference {
	if in == nil {
		return nil
	}
	out := new(FunctionRevisionReference)
	in.DeepCopyInto(out)
	return out
}
...
func (in *PipelineStep) DeepCopyInto(out *PipelineStep) {
	*out = *in
	...
	if in.FunctionRevisionRef != nil {
		in, out := &in.FunctionRevisionRef, &out.FunctionRevisionRef
		*out = new(FunctionRevisionReference)
		**out = **in
	}
	if in.FunctionRevisionSelector != nil {
		in, out := &in.FunctionRevisionSelector, &out.FunctionRevisionSelector
		*out = new(FunctionRevisionSelector)
		(*in).DeepCopyInto(*out)
	}
	if in.Input != nil {
