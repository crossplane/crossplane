...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MergeOptionsPolicy) DeepCopyInto(out *MergeOptionsPolicy) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MergeOptionsPolicy.
func (in *MergeOptionsPolicy) DeepCopy() *MergeOptionsPolicy {
	if in == nil {
		return nil
	}
	out := new(MergeOptionsPolicy)
	in.DeepCopyInto(out)
	return out
}
