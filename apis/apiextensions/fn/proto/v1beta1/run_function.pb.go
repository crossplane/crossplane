...
// We auto-generate API documentation from this file using protoc-gen-docs.
// https://pkg.go.dev/istio.io/tools@latest/cmd/protoc-gen-docs#readme-writing-docs
...
// Package apiextensions.fn.proto.v1beta1 defines the RPCs Crossplane uses to
...
const (
	// Unspecified means the readiness of the resource is unknown.
...
const (
	// Unspecified means the severity of the result is unknown. Crossplane treats
	// results of unspecified severity as warnings.
