...
var file_apiextensions_fn_proto_v1_run_function_proto_rawDesc = string([]byte{
...
var (
	...
	file_apiextensions_fn_proto_v1_run_function_proto_rawDescData []byte
)
...
func file_apiextensions_fn_proto_v1_run_function_proto_rawDescGZIP() []byte {
	file_apiextensions_fn_proto_v1_run_function_proto_rawDescOnce.Do(func() {
		file_apiextensions_fn_proto_v1_run_function_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_apiextensions_fn_proto_v1_run_function_proto_rawDesc), len(file_apiextensions_fn_proto_v1_run_function_proto_rawDesc)))
	})
...
func file_apiextensions_fn_proto_v1_run_function_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_apiextensions_fn_proto_v1_run_function_proto_rawDesc), len(file_apiextensions_fn_proto_v1_run_function_proto_rawDesc)),
			NumEnums:      4,
			NumMessages:   21,
			NumExtensions: 0,
			NumServices:   1,
