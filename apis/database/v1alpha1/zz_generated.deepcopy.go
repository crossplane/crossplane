...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NoSQLInstance) DeepCopyInto(out *NoSQLInstance) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	in.Spec.DeepCopyInto(&out.Spec)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NoSQLInstance.
func (in *NoSQLInstance) DeepCopy() *NoSQLInstance {
	if in == nil {
		return nil
	}
	out := new(NoSQLInstance)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *NoSQLInstance) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NoSQLInstanceList) DeepCopyInto(out *NoSQLInstanceList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]NoSQLInstance, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NoSQLInstanceList.
func (in *NoSQLInstanceList) DeepCopy() *NoSQLInstanceList {
	if in == nil {
		return nil
	}
	out := new(NoSQLInstanceList)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *NoSQLInstanceList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NoSQLInstanceSpec) DeepCopyInto(out *NoSQLInstanceSpec) {
	*out = *in
	in.ResourceClaimSpec.DeepCopyInto(&out.ResourceClaimSpec)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NoSQLInstanceSpec.
func (in *NoSQLInstanceSpec) DeepCopy() *NoSQLInstanceSpec {
	if in == nil {
		return nil
	}
	out := new(NoSQLInstanceSpec)
	in.DeepCopyInto(out)
	return out
}
