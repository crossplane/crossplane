...
type Package interface {
	...
	GetValidationProvider() string
	SetValidationProvider(r string)

	GetValidationSecrets() []corev1.LocalObjectReference
	SetValidationSecrets(s []corev1.LocalObjectReference)
}
...
// GetValidationProvider of this ProviderRevision.
func (p *Provider) GetValidationProvider() string {
	return p.Spec.ValidationProvider
}

// SetValidationProvider of this ProviderRevision.
func (p *Provider) SetValidationProvider(s string) {
	p.Spec.ValidationProvider = s
}

// GetValidationSecrets of this Provider.
func (p *Provider) GetValidationSecrets() []corev1.LocalObjectReference {
	return p.Spec.ValidationSecrets
}

// SetValidationSecrets of this Provider.
func (p *Provider) SetValidationSecrets(s []corev1.LocalObjectReference) {
	p.Spec.ValidationSecrets = s
}
...
// GetValidationProvider of this Configuration.
func (p *Configuration) GetValidationProvider() string {
	return p.Spec.ValidationProvider
}

// SetValidationProvider of this Configuration.
func (p *Configuration) SetValidationProvider(s string) {
	p.Spec.ValidationProvider = s
}

// GetValidationSecrets of this Configuration.
func (p *Configuration) GetValidationSecrets() []corev1.LocalObjectReference {
	return p.Spec.ValidationSecrets
}

// SetValidationSecrets of this Configuration.
func (p *Configuration) SetValidationSecrets(s []corev1.LocalObjectReference) {
	p.Spec.ValidationSecrets = s
}
...
// GetValidationProvider of this ProviderRevision.
func (p *ProviderRevision) GetValidationProvider() string {
	return p.Spec.ValidationProvider
}

// SetValidationProvider of this ProviderRevision.
func (p *ProviderRevision) SetValidationProvider(s string) {
	p.Spec.ValidationProvider = s
}

// GetValidationSecrets of this ProviderRevision.
func (p *ProviderRevision) GetValidationSecrets() []corev1.LocalObjectReference {
	return p.Spec.ValidationSecrets
}

// SetValidationSecrets of this ProviderRevision.
func (p *ProviderRevision) SetValidationSecrets(s []corev1.LocalObjectReference) {
	p.Spec.ValidationSecrets = s
}
...
// GetValidationProvider of this ConfigurationRevision.
func (p *ConfigurationRevision) GetValidationProvider() string {
	return p.Spec.ValidationProvider
}

// SetValidationProvider of this ConfigurationRevision.
func (p *ConfigurationRevision) SetValidationProvider(s string) {
	p.Spec.ValidationProvider = s
}

// GetValidationSecrets of this ConfigurationRevision.
func (p *ConfigurationRevision) GetValidationSecrets() []corev1.LocalObjectReference {
	return p.Spec.ValidationSecrets
}

// SetValidationSecrets of this ConfigurationRevision.
func (p *ConfigurationRevision) SetValidationSecrets(s []corev1.LocalObjectReference) {
	p.Spec.ValidationSecrets = s
}
