...
// TODO(JesseSanford): figure out how to use const for PackageValidationProvider
// PackageValidationProvider is the provider used for validating package signatures
/*type PackageValidationProvider string

const (
  // PackageValidationProviderCosign indicates the cosign signature validation is used
  PackageValidationProviderCosign PackageValidationProvider = "cosign"
)*/
...
type PackageSpec struct {
	...
	// +optional
	// +kubebuilder:default=PackageValidationProviderCosign
	/*ValidationProvider PackageValidationProvider `json:"validationProvider,omitempty"`*/

	// Validation provider used to validate image signatures.
	// +optional
	// +kubebuilder:default=cosign
	ValidationProvider string `json:"validationProvider,omitempty"`

	// ValidationSecrets are named secrets in the same namespace that can be
	// used to validate package signatures.
	// +optional
	ValidationSecrets []corev1.LocalObjectReference `json:"validationSecrets,omitempty"`
}
