...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in EnabledAPIs) DeepCopyInto(out *EnabledAPIs) {
	{
		in := &in
		*out = make(EnabledAPIs, len(*in))
		copy(*out, *in)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new EnabledAPIs.
func (in EnabledAPIs) DeepCopy() EnabledAPIs {
	if in == nil {
		return nil
	}
	out := new(EnabledAPIs)
...
func (in *PackageStatus) DeepCopyInto(out *PackageStatus) {
	*out = *in
	if in.CurrentAPIs != nil {
		in, out := &in.CurrentAPIs, &out.CurrentAPIs
		*out = make(EnabledAPIs, len(*in))
		copy(*out, *in)
	}
}
