...
func (in *ControllerSpec) DeepCopyInto(out *ControllerSpec) {
	*out = *in
	in.StackControllerOptions.DeepCopyInto(&out.StackControllerOptions)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *StackControllerOptions) DeepCopyInto(out *StackControllerOptions) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new StackControllerOptions.
func (in *StackControllerOptions) DeepCopy() *StackControllerOptions {
	if in == nil {
		return nil
	}
	out := new(StackControllerOptions)
	in.DeepCopyInto(out)
	return out
}
