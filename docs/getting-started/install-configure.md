...
helm install crossplane --namespace crossplane-system crossplane-stable/crossplane --version 1.2.4
```
...
```console
kubectl crossplane install configuration registry.upbound.io/xp/getting-started-with-aws:v1.2.5
```
...
```console
kubectl crossplane install configuration registry.upbound.io/xp/getting-started-with-aws-with-vpc:v1.2.5
```
...
```console
kubectl crossplane install configuration registry.upbound.io/xp/getting-started-with-gcp:v1.2.5
```
...
```console
kubectl crossplane install configuration registry.upbound.io/xp/getting-started-with-azure:v1.2.5
```
