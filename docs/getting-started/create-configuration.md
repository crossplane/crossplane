...
```console
curl -OL https://raw.githubusercontent.com/crossplane/crossplane/release-1.6/docs/snippets/package/definition.yaml
```
...
```console
curl -OL https://raw.githubusercontent.com/crossplane/crossplane/release-1.6/docs/snippets/package/aws/composition.yaml
```
...
```console
curl -OL https://raw.githubusercontent.com/crossplane/crossplane/release-1.6/docs/snippets/package/aws-with-vpc/composition.yaml
```
...
```console
curl -OL https://raw.githubusercontent.com/crossplane/crossplane/release-1.6/docs/snippets/package/gcp/composition.yaml
```
...
```console
curl -OL https://raw.githubusercontent.com/crossplane/crossplane/release-1.6/docs/snippets/package/azure/composition.yaml
```
...
```console
curl -OL https://raw.githubusercontent.com/crossplane/crossplane/release-1.6/docs/snippets/package/alibaba/composition.yaml
```
...
```console
curl -OL https://raw.githubusercontent.com/crossplane/crossplane/release-1.6/docs/snippets/package/aws/crossplane.yaml
...
REG=my-package-repo
kubectl crossplane push configuration ${REG}/getting-started-with-aws:v1.6.2
```
...
```console
curl -OL https://raw.githubusercontent.com/crossplane/crossplane/release-1.6/docs/snippets/package/aws-with-vpc/crossplane.yaml
...
# Set this to the Docker Hub username or OCI registry you wish to use.
REG=my-package-repo
kubectl crossplane push configuration ${REG}/getting-started-with-aws-with-vpc:v1.6.2
```
...
```console
curl -OL https://raw.githubusercontent.com/crossplane/crossplane/release-1.6/docs/snippets/package/gcp/crossplane.yaml
...
# Set this to the Docker Hub username or OCI registry you wish to use.
REG=my-package-repo
kubectl crossplane push configuration ${REG}/getting-started-with-gcp:v1.6.2
```
...
```console
curl -OL https://raw.githubusercontent.com/crossplane/crossplane/release-1.6/docs/snippets/package/azure/crossplane.yaml
...
# Set this to the Docker Hub username or OCI registry you wish to use.
REG=my-package-repo
kubectl crossplane push configuration ${REG}/getting-started-with-azure:v1.6.2
```
