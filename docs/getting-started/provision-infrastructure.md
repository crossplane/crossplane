...
```console
kubectl apply -f https://raw.githubusercontent.com/crossplane/crossplane/release-1.3/docs/snippets/compose/claim-aws.yaml
```
...
```console
kubectl apply -f https://raw.githubusercontent.com/crossplane/crossplane/release-1.3/docs/snippets/compose/claim-gcp.yaml
```
...
```console
kubectl apply -f https://raw.githubusercontent.com/crossplane/crossplane/release-1.3/docs/snippets/compose/claim-azure.yaml
```
...
```console
kubectl apply -f https://raw.githubusercontent.com/crossplane/crossplane/release-1.3/docs/snippets/compose/pod.yaml
```
