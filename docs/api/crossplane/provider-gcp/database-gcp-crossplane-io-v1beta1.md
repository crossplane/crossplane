...
`ipAddresses` | [[]*github.com/crossplane/provider-gcp/apis/database/v1beta1.IPMapping](#*github.com/crossplane/provider-gcp/apis/database/v1beta1.IPMapping) | IPAddresses: The assigned IP addresses for the instance.
...
Name | Type | Description
-----|------|------------
`authorizedNetworks` | Optional [[]*github.com/crossplane/provider-gcp/apis/database/v1beta1.ACLEntry](#*github.com/crossplane/provider-gcp/apis/database/v1beta1.ACLEntry) | AuthorizedNetworks: The list of external networks that are allowed to connect to the instance using the IP. In CIDR notation, also known as &#39;slash&#39; notation (e.g. 192.168.100.0/24).
...
`databaseFlags` | Optional [[]*github.com/crossplane/provider-gcp/apis/database/v1beta1.DatabaseFlags](#*github.com/crossplane/provider-gcp/apis/database/v1beta1.DatabaseFlags) | DatabaseFlags is the array of database flags passed to the instance at startup.
