...
* github.com/crossplane/provider-aws/apis/database/v1alpha3.DBSubnetGroupNameReferencer
...
* github.com/crossplane/provider-aws/apis/identity/v1alpha3.IAMRoleNameReferencer
...
`vpcSecurityGroupIDRefs` | Optional [[]*github.com/crossplane/provider-aws/apis/database/v1beta1.VPCSecurityGroupIDReferencerForRDSInstance](#*github.com/crossplane/provider-aws/apis/database/v1beta1.VPCSecurityGroupIDReferencerForRDSInstance) | VPCSecurityGroupIDRefs are references to VPCSecurityGroups used to set the VPCSecurityGroupIDs.
