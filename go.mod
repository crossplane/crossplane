...
require (
	...
	github.com/jmattheis/goverter v0.17.5
...
replace github.com/crossplane/crossplane-runtime => github.com/sttts/crossplane-runtime v0.0.0-20230905100553-9a0fe90f4dc1
